...
from .base import CacheBackend, CacheKey, CacheEntry, CacheConnectionError, CacheSerializationError
...
class RedisCache(CacheBackend):
    ...
    async def get(self, key: CacheKey) -> Optional[CacheEntry]:
        ...
        try:
            ...
            raise CacheConnectionError(f"Redis connection error: {e}")
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for key, value in stats_data.items():
                ...
                value_int = int(value.decode('utf-8') if isinstance(value, bytes) else value)
