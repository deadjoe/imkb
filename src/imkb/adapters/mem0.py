...
class Mem0Adapter:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            has_valid_api_key = (
                llm_router.api_key and 
                not llm_router.api_key.startswith("sk-placeholder") and
                llm_router.api_key != "your-api-key-here"
            )
            ...
            mem0_config["embedder"] = {
                "provider": llm_router.provider,
                "config": {
                    "model": "text-embedding-3-small" if llm_router.provider == "openai" else llm_router.model,
                    "api_key": llm_router.api_key
                }
            }
