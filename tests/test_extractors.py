...
from imkb.extractors import Event, ExtractorBase, KBItem, registry
    ...
    async def test_recall_returns_mysql_knowledge(self):
        ...
        for item in items:
            ...
            assert any(
                ...
                for keyword in ["connection", "mysql", "database", "pool", "timeout"]
            )
...
class TestExtractorRegistry:
    ...
    def test_register_custom_extractor(self):
        ...
        class CustomExtractor(ExtractorBase):
            ...
            async def recall(self, event: Event, k: int = 5) -> list[KBItem]:
                return [
                    KBItem(doc_id="custom_001", excerpt="Custom knowledge", score=0.8)
                ]
...
class TestExtractorIntegration:
    ...
    async def test_event_processing_workflow(self):
        ...
        event_data = {
            ...
            "severity": "critical",
            "source": "monitoring",
            "labels": {"database": "user_db", "service": "mysql"},
    ...
    async def test_knowledge_item_quality(self):
        ...
        for item in knowledge_items:
            ...
            has_relevant_content = any(
                keyword in item.excerpt.lower() for keyword in relevant_keywords
            )
